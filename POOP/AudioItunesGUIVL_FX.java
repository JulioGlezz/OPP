...
public class AudioItunesGUIVL_FX extends JFrame implements ActionListener,ListSelectionListener
{
	//Atributos
	...
	public void reproducir()
	{
		...
		thrAudio= new Thread(new AudioFxOS(cancion));
    	thrAudio.start();
	}
