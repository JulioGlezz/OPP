...
public class AudioItunesGUIVL_ZOOM extends JFrame implements ActionListener,ListSelectionListener
{
	//Atributos
	...
	public void reproducir()
	{
		...
		thrAudio= new Thread(new AudioJavaZoomOS(cancion));
        thrAudio.start();
	}
